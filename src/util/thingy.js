...
/********* ADDITIONAL FUNCTIONS BELOW - ORIGINAL FILE CUSTOMISED *********/

/**
   *  Checks if device is connected.
   *
   *  @return {Boolean} Returns true if device is connected and false otherwise
   *
     */
  isConnected() {
...
/**
   *  Adds callback to be triggered on device diconnect.
   *
   *  @param {handler} onDisconnect - The callback function that is triggered on disconnect.
   *  @param {Boolean} - If true, handler is added. If false, handler is removed.
   *
     */
 addDisconnectListener(onDisconnect, addHandler) {
  if (addHandler) { 
